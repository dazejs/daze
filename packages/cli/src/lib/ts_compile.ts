...
export class TsCompile {
  ...
  reportDiagnostic(diagnostic: ts.Diagnostic) {
    console.error(chalk.yellow(`[Daze][Server]: `) + chalk.red("Error"), diagnostic.code, ":", ts.flattenDiagnosticMessageText( diagnostic.messageText, TsCompile.formatHost.getNewLine()));
  }
  ...
  reportWatchStatusChanged(diagnostic: ts.Diagnostic) {
    console.info(chalk.yellow(`[Daze][Server]: `) + ts.formatDiagnostic(diagnostic, TsCompile.formatHost));
  }
